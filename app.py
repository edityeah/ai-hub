...
def main():
    ...
    with st.sidebar:
       ...
       # Add copyright and blog link below the file uploader
        st.markdown("""
        <hr style='border: 1px solid #444; margin-top: 2rem; margin-bottom: 1rem;'>

        <div style='text-align: center; font-size: 0.9rem; color: #bbb;'>
        © Adityeah | <a href='https://adityeah.in/' target='_blank' style='color: #4f8cff; font-weight: bold; text-decoration: none;'>Visit my Blog</a>
        </div>
        """, unsafe_allow_html=True)
